...
./nbody 2 0.00001f 543847 ../../test-data/circle.dat ~test-outputs/circle.out >> /dev/null
...
./nbody 32 0.001f 10000 ../../test-data/two-lines.dat ~test-outputs/two-lines.out >> /dev/null
